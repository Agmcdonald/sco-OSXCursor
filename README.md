...
- **Merge into CBZ**: Combine a run of CBZ files into one larger book — choose the reading order, name the collection, and keep or trash the originals; pages are renumbered as one sequence and the merged archive is verified before it's saved
